namespace OpenHRCore.WorkForce.Infrastructure.Data
{
    ...
    /// </summary>
    public class OpenHRCoreWorkForceDbContext : DbContext
    {
        /// <summary>
        /// Defines the database schema name for the WorkForce module.
        /// </summary>
        public const string SchemaName = "WorkForce";

        /// <summary>
        /// Initializes a new instance of the <see cref="OpenHRCoreWorkForceDbContext"/> class.
        /// </summary>
        /// <param name="options">The options to be used by the DbContext.</param>
        public OpenHRCoreWorkForceDbContext(DbContextOptions<OpenHRCoreWorkForceDbContext> options) : base(options)
        {
        }
